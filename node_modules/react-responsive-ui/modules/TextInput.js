...
var Text_input = function (_PureComponent) {
	_inherits(Text_input, _PureComponent);
	...
	function Text_input() {
		...
		_classCallCheck(this, Text_input);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Text_input.__proto__ || _Object$getPrototypeOf(Text_input)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.autoresize = function (event) {
			...
			if ((event.ctrlKey || event.metaKey) && event.keyCode === 13) {
				if (submit_parent_form(ReactDOM.findDOMNode(_this.input))) {
