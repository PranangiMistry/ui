...
var Checkbox = function (_PureComponent) {
	...
	function Checkbox() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Checkbox.__proto__ || _Object$getPrototypeOf(Checkbox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.toggle = function (event) {
	...
	_createClass(Checkbox, [{
		...
		value: function draw_checkmark() {
			...
			var path_element = ReactDOM.findDOMNode(this.path);
