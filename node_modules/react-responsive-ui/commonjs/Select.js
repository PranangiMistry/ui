		...
		value: function render_selected_item_only(label_is_shown) {
			...
			return _react2.default.createElement(
				'button',
				{
					...
					className: (0, _classnames2.default)(selected_style_classes, 'rrui__button-reset', 'rrui__select__button', {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						show_selected_as_an_icon ? _react2.default.cloneElement(selected.icon, { title: selected_label }) : selected_text
					),
