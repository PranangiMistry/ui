...
var DatePicker = function (_PureComponent) {
	...
	function DatePicker() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DatePicker.__proto__ || _Object$getPrototypeOf(DatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			expanded: false,
			selected_day: null
			...
			if (!selected_day || disabledDays && ModifiersUtils.dayMatchesModifier(selected_day, disabledDays)) {
			...
			var container = ReactDOM.findDOMNode(_this.container);
	...
	_createClass(DatePicker, [{
		...
		value: function componentDidMount() {
			...
			var calendar = ReactDOM.findDOMNode(this.calendar);
			var _iteratorNormalCompletion = true;
			var _didIteratorError = false;
			var _iteratorError = undefined;

			try {
				for (var _iterator = _getIterator(calendar.querySelectorAll('.DayPicker-NavButton')), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		value: function render() {
			...
			if (selectYearsIntoPast || selectYearsIntoFuture) {
				captionElement = React.createElement(YearMonthSelector, {
					selectedDay: value,
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('div', { className: 'rrui__date-picker__icon' }),
					...
					React.createElement(
						'div',
						{
							className: classNames('rrui__expandable', 'rrui__expandable--overlay', 'rrui__shadow', 'rrui__date-picker__collapsible', {
...
function YearMonthSelector(_ref6) {
	var date = _ref6.date,
	    localeUtils = _ref6.localeUtils,
	    onChange = _ref6.onChange,
	    selectYearsIntoPast = _ref6.selectYearsIntoPast,
	    selectYearsIntoFuture = _ref6.selectYearsIntoFuture,
	    selectedDay = _ref6.selectedDay;
