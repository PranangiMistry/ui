...
var Tooltip = function (_PureComponent) {
	...
	function Tooltip() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tooltip.__proto__ || _Object$getPrototypeOf(Tooltip)).call.apply(_ref, [this].concat(args))), _this), _this.show = function () {
	...
	_createClass(Tooltip, [{
		...
		value: function render() {
			...
			var _props2 = this.props,
			    ...
			    rest = _objectWithoutProperties(_props2, ['inline', 'style', 'className', 'children', 'text', 'delay', 'hidingAnimationDuration', 'container', 'tooltipClassName']);
