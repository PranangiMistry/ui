...
var Checkbox = function (_PureComponent) {
	...
	function Checkbox() {
		...
		return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Checkbox.__proto__ || (0, _getPrototypeOf2.default)(Checkbox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.toggle = function (event) {
	...
	(0, _createClass3.default)(Checkbox, [{
		...
		value: function draw_checkmark() {
			...
			this.setState({ path_style: (0, _extends3.default)({}, path_style, svg_path_style) });
		}
	}, {
		key: 'focus',
